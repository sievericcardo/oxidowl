...
async fn main() -> Result<()> {
    ...
    println!("Classification completed with {} classes\n", classification.hierarchy.len());
    ...
    let equivalent_classes = reasoning_service.clone().get_equivalent_classes(&test_class).await?;
    println!("Equivalent classes for Pump: {} classes found\n", equivalent_classes.len());
