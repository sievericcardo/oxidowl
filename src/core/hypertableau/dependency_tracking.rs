...
impl DependencyTracker {
    ...
    pub fn create_fact(&mut self, description: String, dependency_type: DependencyType) -> Result<FactId> {
    ...
    fn extract_parent_dependencies(&self, dep_type: &DependencyType) -> Result<Vec<DependencySetId>> {
        match dep_type {
