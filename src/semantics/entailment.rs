...
impl EntailmentChecker {
    ...
    fn get_class_assertions<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::ClassAssertionAxiom> + 'a {
    ...
    fn get_object_property_assertions<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::ObjectPropertyAssertionAxiom> + 'a {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_data_property_assertions<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::DataPropertyAssertionAxiom> + 'a {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_subclass_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::SubClassOfAxiom> + 'a {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_disjoint_classes_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::DisjointClassesAxiom> + 'a {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_equivalent_classes_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::EquivalentClassesAxiom> + 'a {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_sub_object_property_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::SubObjectPropertyOfAxiom> + 'a {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_equivalent_object_properties_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::EquivalentObjectPropertiesAxiom> + 'a
    {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_disjoint_object_properties_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::DisjointObjectPropertiesAxiom> + 'a {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_inverse_object_properties_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::InverseObjectPropertiesAxiom> + 'a {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_same_individual_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::SameIndividualAxiom> + 'a {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_different_individuals_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::DifferentIndividualsAxiom> + 'a {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_sub_data_property_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::SubDataPropertyOfAxiom> + 'a {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_functional_object_property_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::FunctionalObjectPropertyAxiom> + 'a {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_inverse_functional_object_property_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::InverseFunctionalObjectPropertyAxiom> + 'a
    {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_reflexive_object_property_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::ReflexiveObjectPropertyAxiom> + 'a {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_irreflexive_object_property_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::IrreflexiveObjectPropertyAxiom> + 'a
    {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_symmetric_object_property_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::SymmetricObjectPropertyAxiom> + 'a {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_asymmetric_object_property_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::AsymmetricObjectPropertyAxiom> + 'a {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_transitive_object_property_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::TransitiveObjectPropertyAxiom> + 'a {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_object_property_domain_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::ObjectPropertyDomainAxiom> + 'a {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn get_object_property_range_axioms<'a>(
        &self,
        ontology: &'a Ontology,
    ) -> impl Iterator<Item = &'a crate::ontology::axioms::ObjectPropertyRangeAxiom> + 'a {
        ontology.axioms.iter().filter_map(|axiom| {
    ...
    fn is_individual_in_class(
        ...
        use crate::core::tableau::{ConceptLabel, Tableau, TableauBuilder};
        ...
        T: PartialEq,
    {
        ...
        set1.iter()
            .any(|item1| set2.iter().any(|item2| item1 == item2))
    }
        ...
        T: PartialEq,
    {
        ...
        set1.iter()
            .any(|axiom1| set2.iter().any(|axiom2| axiom1 == axiom2))
    }

    fn individual_sets_overlap(
        &self,
        set1: &[crate::ontology::Individual],
        set2: &[crate::ontology::Individual],
    ) -> bool {
    ...
    fn is_property_subproperty_by_transitivity(
        &self,
        ontology: &Ontology,
        sub: &crate::ontology::ObjectPropertyExpression,
        super_: &crate::ontology::ObjectPropertyExpression,
    ) -> Result<bool> {
        ...
        for axiom in ontology.axioms() {
            if let crate::ontology::Axiom::SubObjectPropertyOf(sub_axiom) = axiom {
                let sub_prop =
                    self.object_property_expression_to_string(&sub_axiom.sub_property)?;
                let super_prop =
                    self.object_property_expression_to_string(&sub_axiom.super_property)?;
        ...
        Ok(closure
            .get(&sub_str)
            .map_or(false, |set| set.contains(&super_str)))
    }

    fn is_data_property_subproperty_by_transitivity(
        &self,
        ontology: &Ontology,
        sub: &crate::ontology::DataPropertyExpression,
        super_: &crate::ontology::DataPropertyExpression,
    ) -> Result<bool> {
        ...
        for axiom in ontology.axioms() {
            if let crate::ontology::Axiom::SubDataPropertyOf(sub_axiom) = axiom {
                ...
                let super_prop =
                    self.data_property_expression_to_string(&sub_axiom.super_property)?;
    ...
    fn are_individuals_same(
        &self,
        ontology: &Ontology,
        ind1: &crate::ontology::Individual,
        ind2: &crate::ontology::Individual,
    ) -> Result<bool> {
        ...
        for axiom in ontology.axioms() {
            if let crate::ontology::Axiom::SameIndividual(same_axiom) = axiom {
                ...
                let ind1_in_set = individuals
                    .iter()
                    .any(|ind| self.individuals_match(ind, ind1));
                let ind2_in_set = individuals
                    .iter()
                    .any(|ind| self.individuals_match(ind, ind2));
        ...
        Ok(same_closure
            .get(&ind1_str)
            .map_or(false, |set| set.contains(&ind2_str)))
    }

    fn is_class_subclass_of(
        &self,
        ontology: &Ontology,
        sub: &crate::ontology::ClassExpression,
        super_: &crate::ontology::ClassExpression,
    ) -> Result<bool> {
    ...
    fn class_expression_to_string(
        &self,
        expr: &crate::ontology::ClassExpression,
    ) -> Result<String> {
        match expr {
            crate::ontology::ClassExpression::Class(class) => Ok(class.iri.as_str().to_string()),
            ...
            crate::ontology::ClassExpression::ObjectHasValue { property, value } => Ok(format!(
                "∃{}.{{{}}}",
                self.object_property_expression_to_string(property)?,
                self.individual_to_string(value)?
            )),
            crate::ontology::ClassExpression::ObjectHasSelf { property } => Ok(format!(
                "∃{}.Self",
                self.object_property_expression_to_string(property)?
            )),
            ...
            crate::ontology::ClassExpression::ObjectOneOf(individuals) => {
                let parts: Vec<String> = individuals
                    .iter()
            ...
            crate::ontology::ClassExpression::DataHasValue { property, value } => Ok(format!(
                "∃{}.{{{}}}",
                self.data_property_expression_to_string(property)?,
    ...
    fn object_property_expression_to_string(
        &self,
    ...
    fn data_property_expression_to_string(
        &self,
    ...
    fn data_range_to_string(&self, range: &crate::ontology::DataRange) -> Result<String> {
        match range {
            crate::ontology::DataRange::Datatype(dt) => Ok(dt.as_str().to_string()),
            ...
            crate::ontology::DataRange::DatatypeRestriction {
                ...
                let restriction_strings: Result<Vec<String>> = restrictions
                    .iter()
    ...
    fn facet_restriction_to_string(
        &self,
        ...
        match facet {
            ...
            crate::ontology::datatypes::ConstrainingFacet::MinInclusive => {
                Ok("minInclusive".to_string())
            }
            crate::ontology::datatypes::ConstrainingFacet::MaxInclusive => {
                Ok("maxInclusive".to_string())
            }
            crate::ontology::datatypes::ConstrainingFacet::MinExclusive => {
                Ok("minExclusive".to_string())
            }
            crate::ontology::datatypes::ConstrainingFacet::MaxExclusive => {
                Ok("maxExclusive".to_string())
            }
            crate::ontology::datatypes::ConstrainingFacet::TotalDigits => {
                Ok("totalDigits".to_string())
            }
            crate::ontology::datatypes::ConstrainingFacet::FractionDigits => {
                Ok("fractionDigits".to_string())
            }
            crate::ontology::datatypes::ConstrainingFacet::Enumeration => {
                Ok("enumeration".to_string())
            }
            crate::ontology::datatypes::ConstrainingFacet::WhiteSpace => {
                Ok("whiteSpace".to_string())
            }
        }
    }

    fn individuals_match(
        &self,
        ind1: &crate::ontology::Individual,
        ind2: &crate::ontology::Individual,
    ) -> bool {
    ...
    fn extract_property_and_filler_from_restriction(
        &self,
        restriction: &RdfTerm,
        _triple: &Triple,
    ) -> Result<(
        crate::ontology::ObjectPropertyExpression,
    ...
    fn apply_owl_property_semantics(&self, graph: &mut RdfGraph) -> Result<()> {
        ...
        let equiv_prop_triples: Vec<_> = graph
            .find_triples(
                None,
    ...
    fn apply_owl_individual_semantics(&self, graph: &mut RdfGraph) -> Result<()> {
        ...
        let same_as_triples: Vec<_> = graph
            .find_triples(None, Some(&RdfTerm::Iri(OWL_SAME_AS.clone())), None)
            .into_iter()
            .cloned()
            .collect();
        ...
        for triple in &graph.triples {
            match triple.predicate.as_str() {
                ...
                Some("http://www.w3.org/2002/07/owl#inverseOf") => {
                    if let Ok(axiom) =
                        self.create_inverse_object_properties_axiom_from_triple(triple)
                    {
                        axioms.push(axiom);
                    }
                }
    ...
    pub fn create_class_assertion_from_triple(
        &self,
        triple: &Triple,
    ) -> Result<crate::ontology::Axiom> {
        let subject_str = triple
            .subject
            .as_str()
            .ok_or_else(|| Error::ontology_parsing("Invalid subject term in RDF triple"))?;
        let individual = crate::ontology::Individual::named(crate::ontology::IRI::new(subject_str));
        let object_str = triple
            .object
            .as_str()
            .ok_or_else(|| Error::ontology_parsing("Invalid object term in RDF triple"))?;

        let class = crate::ontology::ClassExpression::Class(crate::ontology::Class::new(
            crate::ontology::IRI::new(object_str),
        ));
    ...
    pub fn create_subclass_axiom_from_triple(
        &self,
        triple: &Triple,
    ) -> Result<crate::ontology::Axiom> {
        let subject_str = triple
            ...
            .as_str()
            .ok_or_else(|| Error::ontology_parsing("Invalid subject term in RDF triple"))?;
        let subclass = crate::ontology::ClassExpression::Class(crate::ontology::Class::new(
        ...
        let superclass = crate::ontology::ClassExpression::Class(crate::ontology::Class::new(
            crate::ontology::IRI::new(object_str),
        ));
    ...
    pub fn create_object_property_assertion_from_triple(
        &self,
        triple: &Triple,
    ) -> Result<crate::ontology::Axiom> {
    ...
    pub fn create_data_property_assertion_from_triple(
        &self,
        triple: &Triple,
    ) -> Result<crate::ontology::Axiom> {
        let subject = self.rdf_term_to_individual(&triple.subject)?;
    ...
    pub fn create_property_domain_axiom_from_triple(
        &self,
        triple: &Triple,
    ) -> Result<crate::ontology::Axiom> {
    ...
    pub fn create_property_range_axiom_from_triple(
        &self,
        triple: &Triple,
    ) -> Result<crate::ontology::Axiom> {
        let property = self.rdf_term_to_object_property_expression(&triple.subject)?;
    ...
    pub fn create_equivalent_classes_axiom_from_triple(
        &self,
        triple: &Triple,
    ) -> Result<crate::ontology::Axiom> {
    ...
    pub fn create_disjoint_classes_axiom_from_triple(
        &self,
        triple: &Triple,
    ) -> Result<crate::ontology::Axiom> {
        let class1 = self.rdf_term_to_class_expression(&triple.subject)?;
    ...
    pub fn create_equivalent_properties_axiom_from_triple(
        &self,
        triple: &Triple,
    ) -> Result<crate::ontology::Axiom> {
    ...
    pub fn create_inverse_object_properties_axiom_from_triple(
        &self,
        triple: &Triple,
    ) -> Result<crate::ontology::Axiom> {
        let prop1 = self.rdf_term_to_object_property_expression(&triple.subject)?;
    ...
    pub fn create_same_individual_axiom_from_triple(
        &self,
        triple: &Triple,
    ) -> Result<crate::ontology::Axiom> {
    ...
    pub fn create_different_individuals_axiom_from_triple(
        &self,
        triple: &Triple,
    ) -> Result<crate::ontology::Axiom> {
        let ind1 = self.rdf_term_to_individual(&triple.subject)?;
    ...
    pub fn create_cardinality_axiom_from_triple(
        &self,
        triple: &Triple,
    ) -> Result<crate::ontology::Axiom> {
        ...
        let (property, filler) =
            self.extract_property_and_filler_from_restriction(&triple.subject, triple)?;

        match triple.predicate.as_str() {
            Some("http://www.w3.org/2002/07/owl#minCardinality") => Ok(
            ...
            Some("http://www.w3.org/2002/07/owl#maxCardinality") => Ok(
                crate::ontology::Axiom::SubClassOf(crate::ontology::SubClassOfAxiom {
                    id: self.generate_id() as u64,
                    subclass: restriction_class,
            ...
            Some("http://www.w3.org/2002/07/owl#cardinality") => Ok(
                crate::ontology::Axiom::SubClassOf(crate::ontology::SubClassOfAxiom {
                    id: self.generate_id() as u64,
                    subclass: restriction_class,
            ...
            _ => Err(Error::ontology_parsing(
                "Unknown cardinality restriction type",
            )),
        }
    }

    /// Create intersection axiom from RDF triple
    pub fn create_intersection_axiom_from_triple(
        &self,
        triple: &Triple,
    ) -> Result<crate::ontology::Axiom> {
        // Parse intersection list from RDF
        if let Some(intersection_list) =
            self.parse_rdf_list(&triple.object, &self.create_dummy_graph())
        {
            let operands: Result<Vec<_>> = intersection_list
                .iter()
    ...
    pub fn create_complement_axiom_from_triple(
        &self,
        triple: &Triple,
    ) -> Result<crate::ontology::Axiom> {
        let subject_class = self.rdf_term_to_class_expression(&triple.subject)?;
        ...
        let complement =
            crate::ontology::ClassExpression::ObjectComplementOf(Box::new(complement_of));
    ...
    fn check_class_assertion_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        ...
        for ont_axiom in ontology.axioms() {
            if let crate::ontology::Axiom::ClassAssertion(ont_assertion) = ont_axiom {
                if ont_assertion.individual == assertion.individual {
                    ...
                    if self.is_subclass_in_ontology(
                        &ont_assertion.class,
                        &assertion.class,
                        ontology,
                    )? {
        ...
        for ont_axiom in ontology.axioms() {
            if let crate::ontology::Axiom::EquivalentClasses(equiv) = ont_axiom {
                for class_expr in &equiv.classes {
                    if self.are_class_expressions_equivalent(
                        class_expr,
                        &assertion.class,
                        ontology,
                    )? {
                        ...
                        for other_class in &equiv.classes {
                            if class_expr != other_class {
                                for check_axiom in ontology.axioms() {
                                    if let crate::ontology::Axiom::ClassAssertion(check_assertion) =
                                        check_axiom
                                    {
                                        if check_assertion.individual == assertion.individual
                                            && self.are_class_expressions_equivalent(
                                                other_class,
                                                &check_assertion.class,
                                                ontology,
                                            )?
                                        {
                                            return Ok(true);
    ...
    fn check_object_property_assertion_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        ...
        for ont_axiom in ontology.axioms() {
            if let crate::ontology::Axiom::ObjectPropertyAssertion(ont_assertion) = ont_axiom {
                if ont_assertion.source == assertion.source
                    && ont_assertion.target == assertion.target
                {
                    if self.is_sub_object_property_in_ontology(
                        &ont_assertion.property,
                        &assertion.property,
                        ontology,
                    )? {
                        return Ok(true);
        ...
        for ont_axiom in ontology.axioms() {
            if let crate::ontology::Axiom::EquivalentObjectProperties(equiv) = ont_axiom {
                for prop_expr in &equiv.properties {
                    if self.are_object_property_expressions_equivalent(
                        prop_expr,
                        &assertion.property,
                        ontology,
                    )? {
                        for other_prop in &equiv.properties {
                            if prop_expr != other_prop {
                                for check_axiom in ontology.axioms() {
                                    if let crate::ontology::Axiom::ObjectPropertyAssertion(
                                        check_assertion,
                                    ) = check_axiom
                                    {
                                        if check_assertion.source == assertion.source
                                            && check_assertion.target == assertion.target
                                            && self.are_object_property_expressions_equivalent(
                                                other_prop,
                                                &check_assertion.property,
                                                ontology,
                                            )?
                                        {
                                            return Ok(true);
        ...
        for ont_axiom in ontology.axioms() {
            if let crate::ontology::Axiom::InverseObjectProperties(inverse) = ont_axiom {
                if self.are_object_property_expressions_equivalent(
                    ...
                    for check_axiom in ontology.axioms() {
                        if let crate::ontology::Axiom::ObjectPropertyAssertion(check_assertion) =
                            check_axiom
                        {
    ...
    fn check_data_property_assertion_entailment(
        ...
        for ont_axiom in ontology.axioms() {
            if let crate::ontology::Axiom::DataPropertyAssertion(ont_assertion) = ont_axiom {
                if ont_assertion.individual == assertion.individual
                    && ont_assertion.value == assertion.value
                {
                    if self.is_sub_data_property_in_ontology(
                        &ont_assertion.property,
                        &assertion.property,
                        ontology,
                    )? {
    ...
    fn check_subclass_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        axiom: &crate::ontology::axioms::SubClassOfAxiom,
    ) -> Result<bool> {
    ...
    fn check_equivalent_classes_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        axiom: &crate::ontology::axioms::EquivalentClassesAxiom,
    ) -> Result<bool> {
    ...
    fn check_disjoint_classes_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        axiom: &crate::ontology::axioms::DisjointClassesAxiom,
    ) -> Result<bool> {
    ...
    fn check_sub_object_property_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        axiom: &crate::ontology::axioms::SubObjectPropertyOfAxiom,
    ) -> Result<bool> {
        ...
        if self.is_property_subproperty_by_transitivity(
            ontology,
            &axiom.sub_property,
    ...
    fn check_equivalent_object_properties_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        axiom: &crate::ontology::axioms::EquivalentObjectPropertiesAxiom,
    ) -> Result<bool> {
        ...
        for property_pair in axiom.properties.iter().combinations(2) {
            ...
            let prop1_sub_prop2 = self.check_sub_object_property_entailment(
                ontology,
                &crate::ontology::axioms::SubObjectPropertyOfAxiom {
            ...
            let prop2_sub_prop1 = self.check_sub_object_property_entailment(
                ontology,
                &crate::ontology::axioms::SubObjectPropertyOfAxiom {
                    id: 0, // Using 0 as default axiom ID
    ...
    fn check_disjoint_object_properties_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        axiom: &crate::ontology::axioms::DisjointObjectPropertiesAxiom,
    ) -> Result<bool> {
    ...
    fn check_inverse_object_properties_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        axiom: &crate::ontology::axioms::InverseObjectPropertiesAxiom,
    ) -> Result<bool> {
        ...
        for existing_axiom in self.get_inverse_object_properties_axioms(ontology) {
            if (existing_axiom.property1 == axiom.property1
                && existing_axiom.property2 == axiom.property2)
                || (existing_axiom.property1 == axiom.property2
                    && existing_axiom.property2 == axiom.property1)
            {
                return Ok(true);
            }
        }
    ...
    fn check_object_property_domain_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        axiom: &crate::ontology::axioms::ObjectPropertyDomainAxiom,
    ) -> Result<bool> {
    ...
    fn check_object_property_range_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        axiom: &crate::ontology::axioms::ObjectPropertyRangeAxiom,
    ) -> Result<bool> {
    ...
    fn check_functional_object_property_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        axiom: &crate::ontology::axioms::FunctionalObjectPropertyAxiom,
    ) -> Result<bool> {
        ...
        for assertion in self.get_object_property_assertions(ontology) {
            if assertion.property == axiom.property {
                let entry = subject_objects
                    .entry(assertion.source.clone())
    ...
    fn check_inverse_functional_object_property_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        axiom: &crate::ontology::axioms::InverseFunctionalObjectPropertyAxiom,
    ) -> Result<bool> {
    ...
    fn check_reflexive_object_property_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        axiom: &crate::ontology::axioms::ReflexiveObjectPropertyAxiom,
    ) -> Result<bool> {
        ...
        Ok(!domain_individuals.is_empty()
            && domain_individuals
                .iter()
                .all(|ind| reflexive_pairs.contains(ind)))
    }

    fn check_irreflexive_object_property_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        axiom: &crate::ontology::axioms::IrreflexiveObjectPropertyAxiom,
    ) -> Result<bool> {
    ...
    fn check_symmetric_object_property_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        axiom: &crate::ontology::axioms::SymmetricObjectPropertyAxiom,
    ) -> Result<bool> {
        ...
        Ok(!forward_pairs.is_empty()
            && forward_pairs
                .iter()
                .all(|(x, y)| reverse_pairs.contains(&(x.clone(), y.clone()))))
    }

    fn check_asymmetric_object_property_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        axiom: &crate::ontology::axioms::AsymmetricObjectPropertyAxiom,
    ) -> Result<bool> {
    ...
    fn check_transitive_object_property_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        axiom: &crate::ontology::axioms::TransitiveObjectPropertyAxiom,
    ) -> Result<bool> {
    ...
    fn check_same_individual_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        axiom: &crate::ontology::axioms::SameIndividualAxiom,
    ) -> Result<bool> {
    ...
    fn check_different_individuals_entailment(
        &self,
        ontology: &crate::ontology::Ontology,
        axiom: &crate::ontology::axioms::DifferentIndividualsAxiom,
    ) -> Result<bool> {
    ...
    fn are_class_expressions_equivalent(
        &self,
        ...
        match (expr1, expr2) {
            (
                ...
                for axiom in self.get_equivalent_classes_axioms(ontology) {
                    if axiom
                        .classes
                        .contains(&crate::ontology::ClassExpression::Class(c1.clone()))
                        && axiom
                            .classes
                            .contains(&crate::ontology::ClassExpression::Class(c2.clone()))
                    {
                        return Ok(true);
                    }
                }
    ...
    fn are_object_property_expressions_equivalent(
        &self,
        ...
        match (expr1, expr2) {
            (
                ...
                for axiom in self.get_equivalent_object_properties_axioms(ontology) {
                    if axiom.properties.contains(
                        &crate::ontology::ObjectPropertyExpression::ObjectProperty(p1.clone()),
                    ) && axiom.properties.contains(
                        &crate::ontology::ObjectPropertyExpression::ObjectProperty(p2.clone()),
                    ) {
                        return Ok(true);
                    }
                }
    ...
    fn is_sub_object_property_in_ontology(
        &self,
        sub: &crate::ontology::ObjectPropertyExpression,
        super_: &crate::ontology::ObjectPropertyExpression,
        ontology: &crate::ontology::Ontology,
    ...
    fn is_sub_data_property_in_ontology(
        &self,
        sub: &crate::ontology::DataPropertyExpression,
        super_: &crate::ontology::DataPropertyExpression,
        ontology: &crate::ontology::Ontology,
    ...
    fn apply_el_subclass_rules(&self, graph: &mut RdfGraph) -> Result<()> {
        ...
        let subclass_triples: Vec<_> = graph
            .find_triples(None, Some(&RdfTerm::Iri(RDFS_SUBCLASS_OF.clone())), None)
            .into_iter()
            .cloned()
            .collect();
    ...
    fn apply_el_intersection_rules(&self, graph: &mut RdfGraph) -> Result<()> {
        ...
        let subclass_triples: Vec<_> = graph
            .triples()
            .into_iter()
            .filter(|t| t.predicate == subclass_pred)
            .collect();
        ...
        for triple1 in &subclass_triples {
            for triple2 in &subclass_triples {
                if triple1.subject == triple2.subject && triple1.object != triple2.object {
                    ...
                    let intersection_iri = format!(
                        "{}#intersection_{}_{}",
                        "http://www.example.org/temp",
                        triple1
                            .object
                            .as_iri()
                            .map_or("unknown", |url| url.as_str()),
                        triple2
                            .object
                            .as_iri()
                            .map_or("unknown", |url| url.as_str())
                    ...
                    let intersection_pred =
                        RdfTerm::iri("http://www.w3.org/2002/07/owl#intersectionOf")?;
                    new_triples.push(Triple {
                        subject: intersection_node.into(),
                        predicate: intersection_pred,
                        object: self.create_rdf_list(vec![
                            triple1.object.clone(),
                            triple2.object.clone(),
                        ])?,
                    });
                }
            }
    ...
    fn apply_el_existential_rules(&self, graph: &mut RdfGraph) -> Result<()> {
        ...
        for triple in graph.triples() {
            if triple.predicate == subclass_pred {
                ...
                let restriction_triples: Vec<_> = graph
                    .triples()
                    .into_iter()
                    .filter(|t| t.subject == triple.object && t.predicate == some_values_pred)
                    .collect();

                for restriction in restriction_triples {
                    // Find the property this restriction is on
                    if let Some(property_triple) = graph
                        .triples()
                        .into_iter()
                        .find(|t| t.subject == triple.object && t.predicate == on_property_pred)
                    {
                        // Find individuals of type A (the subclass)
                        for type_triple in graph.triples() {
                            if type_triple.predicate == type_pred
                                && type_triple.object == triple.subject
                            {
                                ...
                                for prop_triple in graph.triples() {
                                    if prop_triple.subject == *individual
                                        && prop_triple.predicate == property_triple.object
                                    {
    ...
    fn apply_el_nominal_rules(&self, graph: &mut RdfGraph) -> Result<()> {
        ...
        for triple in graph.triples() {
            if triple.predicate == subclass_pred {
                ...
                if let Some(nominal_triple) = graph
                    .triples()
                    .into_iter()
                    .find(|t| t.subject == triple.object && t.predicate == one_of_pred)
                {
                    // Parse the oneOf list to get the nominal individual(s)
                    let nominals = self
                        .parse_rdf_list(&nominal_triple.object, graph)
    ...
    fn apply_ql_property_rules(&self, graph: &mut RdfGraph) -> Result<()> {
        ...
        let subprop_triples: Vec<_> = graph
            .find_triples(None, Some(&RdfTerm::Iri(RDFS_SUBPROPERTY_OF.clone())), None)
            .into_iter()
            .cloned()
            .collect();
        ...
        for subprop_triple in subprop_triples {
            if let (RdfTerm::Iri(sub_prop), RdfTerm::Iri(super_prop)) =
                (&subprop_triple.subject, &subprop_triple.object)
            {
                // If P ⊑ Q and (x,y) ∈ P, then (x,y) ∈ Q
                let prop_assertions: Vec<_> = graph
                    .find_triples(None, Some(&RdfTerm::Iri(sub_prop.clone())), None)
                    .into_iter()
                    .cloned()
                    .collect();
    ...
    fn apply_ql_domain_range_rules(&self, graph: &mut RdfGraph) -> Result<()> {
        ...
        let domain_triples: Vec<_> = graph
            .find_triples(None, Some(&RdfTerm::Iri(RDFS_DOMAIN.clone())), None)
            .into_iter()
            .cloned()
            .collect();
        ...
        for domain_triple in domain_triples {
            if let RdfTerm::Iri(property) = &domain_triple.subject {
                let prop_assertions: Vec<_> = graph
                    .find_triples(None, Some(&RdfTerm::Iri(property.clone())), None)
                    .into_iter()
                    .cloned()
                    .collect();
        ...
        let range_triples: Vec<_> = graph
            .find_triples(None, Some(&RdfTerm::Iri(RDFS_RANGE.clone())), None)
            .into_iter()
            .cloned()
            .collect();
    ...
    fn rdf_term_to_individual(&self, term: &RdfTerm) -> Result<crate::ontology::Individual> {
        match term {
            ...
            RdfTerm::BlankNode(id) => Ok(crate::ontology::Individual::Anonymous(
                crate::ontology::individuals::AnonymousIndividual { id: id.clone() },
            )),
            _ => Err(Error::reasoning("Invalid individual term")),
        }
    }

    fn rdf_term_to_class_expression(
        &self,
        term: &RdfTerm,
        ...
        match term {
            ...
            _ => Err(Error::reasoning(
                "Complex class expressions not supported in simple conversion",
            )),
        }
    }

    fn rdf_term_to_object_property_expression(
        &self,
        term: &RdfTerm,
        ...
        match term {
            ...
            _ => Err(Error::reasoning(
                "Complex object property expressions not supported in simple conversion",
            )),
        }
    }

    fn rdf_term_to_data_property_expression(
        &self,
        term: &RdfTerm,
    ) -> Result<crate::ontology::DataPropertyExpression> {
        match term {
            ...
            _ => Err(Error::reasoning(
                "Complex data property expressions not supported in simple conversion",
            )),
        }
    }
        ...
        match term {
            RdfTerm::Literal {
                ...
                let datatype_iri = datatype
                    ...
                    .unwrap_or_else(|| {
                        crate::ontology::IRI::from(
                            url::Url::parse("http://www.w3.org/2001/XMLSchema#string").unwrap(),
                        )
                    });
...
impl Owl2RlEngine {
    ...
    pub fn reason(&mut self) -> Result<()> {
        ...
        if iteration >= MAX_ITERATIONS {
            return Err(Error::reasoning(
                "OWL 2 RL reasoning did not converge".to_string(),
            ));
        }
    ...
    fn apply_scm_equivalent_classes(&mut self, graph: &RdfGraph) -> Result<()> {
        ...
        let equiv_class_triples: Vec<_> = graph
            .find_triples(
                None,
                Some(&RdfTerm::Iri(OWL_EQUIVALENT_CLASS.clone())),
                None,
                        ...
                        for individual_triple in &graph.triples {
                            if self.is_iri(
                                ...
                                let is_instance_of_all = class_list.iter().all(|class_term| {
                                    if let Ok(type_predicate) = RdfTerm::iri(
                                        "http://www.w3.org/1999/02/22-rdf-syntax-ns#type",
                                    ) {
                                        let type_triple = Triple {
                                            subject: individual.clone(),
                        ...
                        for type_triple in &graph.triples {
                                ...
                                && type_triple.object == *class_d
                            {
                                ...
                                return Err(Error::reasoning(&format!(
                                    "Inconsistency: Individual {} is asserted to be both {} and its complement {}",
                ...
                if let Some(property) = self.find_restriction_property(restriction, graph) {
                    ...
                    for type_triple in &graph.triples {
                        ...
                        ) && type_triple.object == *restriction
                        {
                            ...
                            for prop_triple in &graph.triples {
                                if prop_triple.subject == *individual
                                    && prop_triple.predicate
                                        == RdfTerm::Iri(property.to_url().unwrap())
                                {
        ...
        for restriction_triple in &graph.triples {
            if self.is_iri(
                ...
                if let Some(cardinality) =
                    self.extract_cardinality_value(&restriction_triple.object)
                {
                    // Find the property for this restriction
                    if let Some(property) = self.find_on_property(graph, restriction) {
                        ...
                        for type_triple in &graph.triples {
                            ...
                            ) && type_triple.object == *restriction
                            {
                                ...
                                for prop_triple in &graph.triples {
                                    if prop_triple.subject == *individual
                                        && prop_triple.predicate == property
                                    {
                                ...
                                if property_values.len() > cardinality {
                                    ...
                                    if cardinality == 0 {
                                        return Err(Error::reasoning(&format!(
                                            "Max cardinality violation: Individual {} has {} values for property {}, but max cardinality is 0",
                                            individual,
                                            property_values.len(),
                                            property
                                        )));
    ...
    fn apply_prp_inverse_functional(&mut self, graph: &RdfGraph) -> Result<()> {
        ...
        let inv_functional_props =
            graph.find_triples(None, Some(&type_iri), Some(&inv_functional_iri));
    ...
    fn apply_prp_transitive(&mut self, graph: &RdfGraph) -> Result<()> {
        ...
        for trans_prop_triple in transitive_props {
            ...
            // Find all uses of this property
            let property_uses: Vec<_> = graph
                .find_triples(None, Some(property), None)
                .into_iter()
                .cloned()
                .collect();
    ...
    fn parse_rdf_list_from_predicate(
        &self,
        subject: &RdfTerm,
        predicate_iri: &str,
        graph: &RdfGraph,
    ...
    pub fn create_cardinality_axiom_from_triple(
        ...
        Err(Error::reasoning(
            "Cardinality axiom parsing not implemented",
        ))
    }
    ...
    pub fn create_intersection_axiom_from_triple(
        ...
        Err(Error::reasoning(
            "Intersection axiom parsing not implemented",
        ))
    }
    ...
    pub fn create_property_chain_axiom_from_triple(
        ...
        Err(Error::reasoning(
            "Property chain axiom parsing not implemented",
        ))
    }
    ...
    fn axiom_sets_overlap(
        &self,
        set1: &[crate::ontology::ClassExpression],
        set2: &[crate::ontology::ClassExpression],
    ) -> bool {
        set1.iter().any(|item| set2.contains(item))
    }

    /// Helper method to check if two property sets overlap
    fn property_sets_overlap(
        &self,
        set1: &[crate::ontology::ObjectPropertyExpression],
        set2: &[crate::ontology::ObjectPropertyExpression],
    ) -> bool {
        set1.iter().any(|item| set2.contains(item))
    }
    ...
    fn is_sub_object_property_in_ontology(
        &self,
        _super_property: &crate::ontology::ObjectPropertyExpression,
        _sub_property: &crate::ontology::ObjectPropertyExpression,
        _ontology: &Ontology,
    ) -> Result<bool> {
    ...
    fn is_sub_data_property_in_ontology(
        &self,
        _super_property: &crate::ontology::DataPropertyExpression,
        _sub_property: &crate::ontology::DataPropertyExpression,
        _ontology: &Ontology,
    ) -> Result<bool> {
        // For now, return false - this would need proper implementation
        Ok(false)
