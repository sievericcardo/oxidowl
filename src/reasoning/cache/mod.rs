...
impl MultiLevelCacheManager {
    ...
    pub fn new() -> Self {
        Self {
            ...
            expander: SatExpanderCache::new(50_000, Duration::from_secs(3600)),
            completion_graph: CompletionGraphCache::new(10_000, Duration::from_secs(3600)),
            saturation: SaturationCache::new(),
            consequences: ConsequencesCache::new(Duration::from_secs(3600)),
        }
    }
