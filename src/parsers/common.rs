...
/// Configuration for ontology serializers
#[derive(Debug, Clone)]
...
impl Default for SerializerConfig {
    fn default() -> Self {
        Self {
            ...
            add_banner: false,
            pretty_print: true,
            use_short_iris: false,
            namespace_map: std::collections::HashMap::new(),
        }
    }
}

/// Generate a banner comment identifying the serializer
#[must_use]
pub fn generate_banner() -> String {
    "# Generated by OxidOwl v1.0.0\n".to_string()
}
