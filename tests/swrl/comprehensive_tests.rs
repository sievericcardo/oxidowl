...
mod comprehensive_tests {
    ...
    fn test_phase2_datetime_builtins() {
        ...
        assert!(
            registry
                .get_builtin("http://www.w3.org/2003/11/swrlb#dateTimeLessThan")
                .is_some()
        );
        assert!(
            registry
                .get_builtin("http://www.w3.org/2003/11/swrlb#monthFromDateTime")
                .is_some()
        );
        assert!(
            registry
                .get_builtin("http://www.w3.org/2003/11/swrlb#dayFromDateTime")
                .is_some()
        );
        assert!(
            registry
                .get_builtin("http://www.w3.org/2003/11/swrlb#hourFromDateTime")
                .is_some()
        );
        assert!(
            registry
                .get_builtin("http://www.w3.org/2003/11/swrlb#dateEqual")
                .is_some()
        );
        assert!(
            registry
                .get_builtin("http://www.w3.org/2003/11/swrlb#timeEqual")
                .is_some()
        );
        ...
        assert!(
            builtin_count >= 15,
            "Expected at least 15 datetime built-ins, got {}",
            builtin_count
        );
    }
    ...
    fn test_datetime_comparison_operations() {
        ...
        if let Some(builtin) =
            registry.get_builtin("http://www.w3.org/2003/11/swrlb#dateTimeLessThan")
        {
            ...
            assert!(
                result.is_ok(),
                "dateTimeLessThan should execute successfully"
            );
        }
    }
    ...
    fn test_datetime_component_extraction() {
        ...
        if let Some(builtin) =
            registry.get_builtin("http://www.w3.org/2003/11/swrlb#monthFromDateTime")
        {
            ...
            assert!(
                result.is_ok(),
                "monthFromDateTime should execute successfully"
            );
        }
    }
    ...
    fn test_regex_builtins_registry() {
        ...
        assert!(
            registry
                .get("http://www.w3.org/2003/11/swrlb#matches")
                .is_some()
        );
        assert!(
            registry
                .get("http://www.w3.org/2003/11/swrlb#replace")
                .is_some()
        );
        assert!(
            registry
                .get("http://www.w3.org/2003/11/swrlb#regexReplace")
                .is_some()
        );
        assert!(
            registry
                .get("http://www.w3.org/2003/11/swrlb#tokenize")
                .is_some()
        );
        assert!(
            registry
                .get("http://www.w3.org/2003/11/swrlb#split")
                .is_some()
        );
        assert!(
            registry
                .get("http://www.w3.org/2003/11/swrlb#extract")
                .is_some()
        );
        assert!(
            registry
                .get("http://www.w3.org/2003/11/swrlb#extractAll")
                .is_some()
        );
        assert!(
            registry
                .get("http://www.w3.org/2003/11/swrlb#isValidPattern")
                .is_some()
        );
    ...
    fn test_regex_pattern_matching() {
        ...
        if let Some(builtin) = registry.get("http://www.w3.org/2003/11/swrlb#matches") {
            ...
            let result = builtin.execute(&args).expect("Test operation failed");
    ...
    fn test_comprehensive_feature_integration() {
        ...
        assert!(
            stats.total_builtins >= 30,
            "Expected at least 30 total built-ins, got {}",
            stats.total_builtins
        );
        assert!(
            stats.datetime_builtins >= 15,
            "Expected at least 15 datetime built-ins, got {}",
            stats.datetime_builtins
        );
        assert_eq!(
            stats.regex_builtins, 8,
            "Expected exactly 8 regex built-ins, got {}",
            stats.regex_builtins
        );
        assert!(
            stats.feature_coverage >= 50.0,
            "Expected at least 50% feature coverage, got {:.1}%",
    ...
    fn test_feature_completeness() {
        ...
        for builtin in key_builtins {
            assert!(
                all_iris.contains(&builtin.to_string()),
                "Missing key built-in: {}",
                builtin
            );
        }

        println!(
            "✓ Feature implementation complete with {} built-ins",
            all_iris.len()
        );
