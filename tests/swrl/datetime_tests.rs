...
use oxidowl::ontology::{IRI, Literal};
use oxidowl::swrl::SWRLValue;
use oxidowl::swrl::datetime_builtins::{
    DateTimeBuiltInRegistry, DateTimeEqualBuiltIn, YearFromDateTimeBuiltIn,
};
...
mod tests {
    ...
    fn test_datetime_built_in_registry() {
        ...
        assert!(
            registry
                .get_builtin("http://www.w3.org/2003/11/swrlb#dateTimeEqual")
                .is_some()
        );
        assert!(
            registry
                .get_builtin("http://www.w3.org/2003/11/swrlb#yearFromDateTime")
                .is_some()
        );
    ...
    fn test_invalid_temporal_values() {
        ...
        for literal in invalid_literals {
            ...
            assert!(
                result.is_err(),
                "Should fail to parse invalid temporal value: {}",
                literal.value
            );
        }
    }
