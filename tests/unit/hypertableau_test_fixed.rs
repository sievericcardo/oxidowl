...
fn test_monitor_integration() {
    use oxidowl::core::hypertableau::monitor::{MonitoringLevel, TableauMonitor};
...
use oxidowl::{
    config::ReasoningConfig, core::blocking::AnywhereBlocking, core::hypertableau::HyperTableau,
    ontology::Ontology,
};
